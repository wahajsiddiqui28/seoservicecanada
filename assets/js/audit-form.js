    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        forms.forEach(function (form) {
            ...
            form.addEventListener('submit', function (e) {
                ...
                // Collect selected services (multi-select checkboxes)
                var selectedServices = [];
                form.querySelectorAll('input[name="services[]"]:checked').forEach(function(cb) {
                    selectedServices.push(cb.value);
                });
                formData.append('audit_services', selectedServices.join(', '));

                // Message textarea
                var msgField = form.querySelector('[name="message"]');
                formData.append('audit_message', msgField ? msgField.value : '');
