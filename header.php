...
<head>
    ...
    <link rel="icon" href="https://seoservicecanada.com/wp-content/themes/seoservicecanada/assets/images/logo/favicon.ico">
    <meta name="google-site-verification" content="it9eQASoYuCOh8O6qTBeFhpVp8jthU1N_KQD7Y1UA7o" />
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PZ3D38R7TH"></script>
                ...
                <div class="collapse navbar-collapse" id="primaryNav">
                    <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
                        ...
                        wp_nav_menu(array(
                            ...
                            'container'      => false,
                            'items_wrap'     => '%3$s',
                            'fallback_cb'    => 'ssc_fallback_menu_items',
                            'depth'          => 2,
                        ...
                        <!-- Services Mega Menu -->
                        <?php get_template_part('template-parts/header/services-mega-menu'); ?>

                        <!-- Provinces Mega Menu -->
                        <?php get_template_part('template-parts/header/provinces-mega-menu'); ?>
                    </ul>
